...
import static dev.gdawg.qolvaultsandnotes.ModItems.BULLETIN_BOARD_ITEM;
import static dev.gdawg.qolvaultsandnotes.ModItems.SAFE_ITEM;
...
public class ModCreativeTabs {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> EXAMPLE_TAB = CREATIVE_MODE_TABS.register("qolvaultsandnotes", () -> CreativeModeTab.builder()
